...
class AI_Products_Order_Widget
{
    ...
    private function init_hooks()
    {
        ...
        // New API proxy handlers (for modal widget and LOA standalone)
        add_action('wp_ajax_aipw_api_proxy', [$this, 'handle_api_proxy']);
        add_action('wp_ajax_nopriv_aipw_api_proxy', [$this, 'handle_api_proxy']);

        // Porting LOA API handlers (deprecated - now routing through api_proxy)
     ...
     * @deprecated Now routing through ApiProxy instead
     */
